...
# define initial keys i.e. thus required to POST the first creation
# sheet (using Content-type: multipart/msigned).
cat << EOF >> pub/udc/creations/initkeys
0F16B563D2768EA62B36A13C442C7E45EEF5EAE6
20D11AC53DAE0E19DFEEE1465D2662E0F300EBAD
501AA42CD027827FAF60EEDC894F60E8F4162D69
EOF
...
cat << EOF | gpg --import --homedir gpgme 2> /dev/null ; ((isroot)) && chown "$LUDDUSER" gpgme/*.gpg
