...
SET(CPACK_COMPONENTS_ALL lud ludd libraries test examples)
SET(CPACK_ALL_INSTALL_TYPES Minimal Full)

SET(CPACK_COMPONENT_LUD_DISPLAY_NAME "${PACKAGE_NAME}")
SET(CPACK_COMPONENT_LUD_DESCRIPTION "${PACKAGE_NAME} client")
SET(CPACK_COMPONENT_LUD_GROUP "Runtime")
SET(CPACK_COMPONENT_LUD_INSTALL_TYPES Full)

SET(CPACK_COMPONENT_LUDD_DISPLAY_NAME "${PACKAGE_NAME}")
SET(CPACK_COMPONENT_LUDD_DESCRIPTION "${PACKAGE_NAME} node")
SET(CPACK_COMPONENT_LUDD_GROUP "Runtime")
SET(CPACK_COMPONENT_LUDD_INSTALL_TYPES Full)
